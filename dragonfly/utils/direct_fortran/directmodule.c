 ...
 * Generation date: Fri Jan 18 20:28:12 2019
...
/* See f2py2e/rules.py */
extern void F_FUNC(direct,DIRECT)(cb_fcn_in_direct__user__routines_typedef,double*,int*,double*,int*,int*,double*,double*,double*,int*,int*,string,string,double*,double*,double*,double*,int*,int*,double*,int*,string*,int*,size_t,size_t);
/*eof externroutines*/
...
/*pyobjfrom*/
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i) {
    ...
    /*XXX: Hmm, what will destroy this array??? */
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,iidata_Dims,NPY_INT,NULL,(char*)iidata,itemsize_,NPY_ARRAY_FARRAY,NULL);
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i) {
    int itemsize_ = NPY_DOUBLE == NPY_STRING ? 1 : 0;
    /*XXX: Hmm, what will destroy this array??? */
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,ddata_Dims,NPY_DOUBLE,NULL,(char*)ddata,itemsize_,NPY_ARRAY_FARRAY,NULL);
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i) {
    ...
    /*XXX: Hmm, what will destroy this array??? */
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,2,cdata_Dims,NPY_STRING,NULL,(char*)cdata,itemsize_,NPY_ARRAY_CARRAY,NULL);
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i)
    if (CAPI_ARGLIST_SETITEM(capi_i++,pyobj_from_int1(n)))
      goto capi_fail;
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i)
    if (CAPI_ARGLIST_SETITEM(capi_i++,pyobj_from_int1(iisize)))
      goto capi_fail;
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i)
    if (CAPI_ARGLIST_SETITEM(capi_i++,pyobj_from_int1(idsize)))
      goto capi_fail;
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i)
    if (CAPI_ARGLIST_SETITEM(capi_i++,pyobj_from_int1(icsize)))
      goto capi_fail;
...
#endif
#ifdef PYPY_VERSION
  capi_return = PyObject_CallObject(cb_fcn_in_direct__user__routines_capi,(PyObject *)capi_arglist_list);
...
x,fmin,ierror = direct(fcn,eps,maxf,maxt,l,u,algmethod,logfilename,kky_results_file_name,fglobal,fglper,volper,sigmaper,iidata,ddata,cdata,[n,iisize,idsize,icsize,fcn_extra_args])\n\nWrapper for ``direct``.\
\n\nParameters\n----------\n"
...
"kky_results_file_name : input string(len=-1)\n"
"fglobal : input float\n"
"fglper : input float\n"
"volper : input float\n"
...
"iisize : input int, optional\n    Default: len(iidata)\n"
"idsize : input int, optional\n    Default: len(ddata)\n"
"icsize : input int, optional\n    Default: shape(cdata,0)\n"
"\nReturns\n-------\n"
...
static PyObject *f2py_rout_direct_direct(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(cb_fcn_in_direct__user__routines_typedef,double*,int*,double*,int*,int*,double*,double*,double*,int*,int*,string,string,double*,double*,double*,double*,int*,int*,double*,int*,string*,int*,size_t,size_t)) {
...
/*decl*/
  ...
  string kky_results_file_name = NULL;
  int slen(kky_results_file_name);
  PyObject *kky_results_file_name_capi = Py_None;
  double fglobal = 0;
  ...
  static char *capi_kwlist[] = {"fcn","eps","maxf","maxt","l","u","algmethod","logfilename","kky_results_file_name","fglobal","fglper","volper","sigmaper","iidata","ddata","cdata","n","iisize","idsize","icsize","fcn_extra_args",NULL};
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOOOOOO|OOOOO!:direct.direct",\
    capi_kwlist,&fcn_capi,&eps_capi,&maxf_capi,&maxt_capi,&l_capi,&u_capi,&algmethod_capi,&logfilename_capi,&kky_results_file_name_capi,&fglobal_capi,&fglper_capi,&volper_capi,&sigmaper_capi,&iidata_capi,&ddata_capi,&cdata_capi,&n_capi,&iisize_capi,&idsize_capi,&icsize_capi,&PyTuple_Type,&fcn_xa_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable fmin */
  /* Processing variable fglper */
    f2py_success = double_from_pyobj(&fglper,fglper_capi,"direct.direct() 11st argument (fglper) can't be converted to double");
  if (f2py_success) {
  ...
  if (f2py_success) {
  /* Processing variable kky_results_file_name */
  slen(kky_results_file_name) = -1;
  f2py_success = string_from_pyobj(&kky_results_file_name,&slen(kky_results_file_name),"",kky_results_file_name_capi,"string_from_pyobj failed in converting 9th argument `kky_results_file_name' of direct.direct to C string");
  if (f2py_success) {
  ...
  capi_cdata_tmp = array_from_pyobj(NPY_STRING,cdata_Dims,cdata_Rank,capi_cdata_intent,cdata_capi);
  if (capi_cdata_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(direct_error,"failed in converting 16th argument `cdata' of direct.direct to C/Fortran array" );
  } else {
    cdata = (string *)(PyArray_DATA(capi_cdata_tmp));

  /* Processing variable ddata */
  ;
  capi_ddata_intent |= F2PY_INTENT_IN;
  capi_ddata_tmp = array_from_pyobj(NPY_DOUBLE,ddata_Dims,ddata_Rank,capi_ddata_intent,ddata_capi);
  if (capi_ddata_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(direct_error,"failed in converting 15th argument `ddata' of direct.direct to C/Fortran array" );
  } else {
    ddata = (double *)(PyArray_DATA(capi_ddata_tmp));
...
if(F2PyCapsule_Check(fcn_capi)) {
  ...
  /* Processing variable sigmaper */
    f2py_success = double_from_pyobj(&sigmaper,sigmaper_capi,"direct.direct() 13rd argument (sigmaper) can't be converted to double");
  if (f2py_success) {
  ...
  /* Processing variable fglobal */
    f2py_success = double_from_pyobj(&fglobal,fglobal_capi,"direct.direct() 10th argument (fglobal) can't be converted to double");
  if (f2py_success) {
  /* Processing variable iidata */
  ;
  capi_iidata_intent |= F2PY_INTENT_IN;
  capi_iidata_tmp = array_from_pyobj(NPY_INT,iidata_Dims,iidata_Rank,capi_iidata_intent,iidata_capi);
  if (capi_iidata_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(direct_error,"failed in converting 14th argument `iidata' of direct.direct to C/Fortran array" );
  } else {
    iidata = (int *)(PyArray_DATA(capi_iidata_tmp));

  /* Processing variable volper */
    f2py_success = double_from_pyobj(&volper,volper_capi,"direct.direct() 12nd argument (volper) can't be converted to double");
  if (f2py_success) {
...
/*callfortranroutine*/
    if ((setjmp(cb_fcn_in_direct__user__routines_jmpbuf))) {
      f2py_success = 0;
        ...
        (*f2py_func)(fcn_cptr,x,&n,&eps,&maxf,&maxt,&fmin,l,u,&algmethod,&ierror,logfilename,kky_results_file_name,&fglobal,&fglper,&volper,&sigmaper,iidata,&iisize,ddata,&idsize,cdata,&icsize,slen(logfilename),slen(kky_results_file_name));
    }
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*cleanupfrompyobj*/
  ...
  /* End of cleaning variable logfilename */
    STRINGFREE(kky_results_file_name);
  }  /*if (f2py_success) of kky_results_file_name*/
  /* End of cleaning variable kky_results_file_name */
...
"  x,fmin,ierror = direct(fcn,eps,maxf,maxt,l,u,algmethod,logfilename,kky_results_file_name,fglobal,fglper,volper,sigmaper,iidata,ddata,cdata,n=len(l),iisize=len(iidata),idsize=len(ddata),icsize=shape(cdata,0),fcn_extra_args=())\n"
"COMMON blocks:\n""  /directcontrol/ jones\n"".");
