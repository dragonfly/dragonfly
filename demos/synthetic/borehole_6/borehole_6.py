"""
  Borehole function in 8 dimensions.
  This function assumes that the input is a list of 6 elements in the following order:
  a one dimensional int, a 2D float, a 1D float, a 2D int.
...
def borehole_6(x):
  ...
  return borehole_6_z(x, [1.0, 1.0])

def borehole_6_z(x, z):
  """ Computes the Bore Hole function. """
  # pylint: disable=bad-whitespace
  rw = x[0][0]
